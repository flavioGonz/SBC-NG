...
// Encabezado de página consistente: barra de acento + chip de ícono + título + subtítulo + acciones.
export default function PageHeader({ icon, title, subtitle, color = 'sbc', right }) {
  return (
    <Group justify="space-between" align="center" wrap="wrap" gap="sm" mb={2}>
      <div className="sbc-pagehead">
        <span className="sbc-acc-bar" style={{ background: `linear-gradient(180deg, var(--mantine-color-${color}-5), var(--mantine-color-${color}-8))` }} />
