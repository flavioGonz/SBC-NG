...
/* El tema es EL MISMO que el de PBX-NG (misma escala, misma tipografía, mismos
 * defaults de componentes). Son dos productos distintos, pero de la misma casa:
 * un técnico que sabe usar uno tiene que sentirse en casa en el otro.
 * Lo único propio del SBC es el acento secundario cian (--sbc-accent2), que se
 * usa para las cosas de red. */
export const theme = createTheme({
  ...
  colors: {
    sbc: ['#e9f2ff', '#cfe0fb', '#9dbef3', '#6a9aec', '#437fe6', '#2f74e6', '#1f63d8', '#1750c2', '#0f3f9e', '#06306f'],
  ...
  components: {
    ...
    Modal: { defaultProps: { radius: 'lg', centered: true, size: 'lg', overlayProps: { blur: 6, backgroundOpacity: 0.5 } } },
